...
if __name__ == "__main__":
    ...
    parser.add_argument('--action', type=str,
                        ...
                        default='sfm')
    # for video2image
    parser.add_argument('--input', type=str, default='data/custom/video/mouse-ref.mp4')
    parser.add_argument('--output', type=str, default=f'data/custom/{database_name_name}/images')
    ...
    # for sfm
    parser.add_argument('--database_name', type=str, default=f'custom/{database_name_name}')
    parser.add_argument('--colmap_path', type=str,
                        # default='colmap')
                        default=r"G:\redmi_OVERSEA\APP__quick\COLMAP-3.8-windows-cuda\COLMAP.bat")
    # for sfm
