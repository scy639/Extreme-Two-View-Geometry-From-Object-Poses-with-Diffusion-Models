...
import torchvision
import numpy as np
from .operator import pose_apply_th, normalize_coords
from .pretrain_models import VGGBNPretrainV3
if __name__.count(".")>=2:
...
class VolumeRefiner(nn.Module):
    ...
    def refine_que_imgs(self, que_img, que_K, in_pose, size=128, ref_num=6, ref_even=False):
        ...
        #lpTODO vis to compare with my look_at_crop in eavl level
        que_imgs_info = {
