...
class DDPM(pl.LightningModule):
    ...
    def __init__(self,
        ...
        #scy: 操你妈！动态加载你妈啊！草！傻逼！猪！吃你妈的屎去吧FUCKKKKKKKKKKKKKK YOU
        self.model = DiffusionWrapper(unet_config, conditioning_key)#scy:unet is ldm.modules.diffusionmodules.openaimodel.UNetModel
